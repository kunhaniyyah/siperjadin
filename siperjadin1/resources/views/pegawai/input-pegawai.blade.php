...
<head>
  ...
  <title>@yield('title', 'Halaman Input Data Pegawai')</title>
              ...
              <div class="card-body">
                <table class="table-bordered">
                 ...
                 {{ csrf_field() }}
                  ...
                  <label for=""> NIP  </label>
                    <input type="text" id="nama" name="nip" class="form-control" @error('nama') is-invalid @enderror placeholder="NIP" value="{{ old('nip') }}">
